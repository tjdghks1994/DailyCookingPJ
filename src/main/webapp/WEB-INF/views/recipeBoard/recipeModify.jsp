...
<div style="background-color: lightgray;">
	...
	<div class="recipeDiv">
	    <div class="recipeSemiDiv">
	      ...
	      <div class="">
	      	<p class="titles">재료 </p>
	      	<textarea class="form-control step_cont" placeholder="예) 소고기 500g, 설탕 1/2 스푼, 물 300ml (재료가 남거나 부족하지 않도록 정확한 계량정보를 적어주세요!)">
	      	면 1인분, 물 350ml, 계란 1개, 고추장 2스푼 등등
	      	</textarea>
	      </div>
	      ...
	      <div>
	        ...
	        <select id="cookTime"  text="요리시간">
				...
				<option value="10" selected="selected">10분이내</option>
	        ...
	        <select id="cookLevel" text="난이도">
				...
				<option value="1" selected="selected">매우 쉬움</option>
